                    ...
                    <div className=" h-[100%] text-black overflow-hidden">
                        <ul className="lg:inline-flex h-[100%] text-black">
                            <li className='animate-smart ease-in 300sec h-[100%] '>
                                <NavLink className=" pt-[54px] lg:inline-flex lg:w-auto px-4 mx-4 py-2 rounded font-extrabold font-sans text-base leading-[21.82px] tracking-[1%]  " activeclassname='active ' to="/">Home</NavLink>
                            </li>
